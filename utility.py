...
def load_assests():
    ...
    spaceshipImageYellow = pygame.image.load(os.path.join("Assets", "yellow.png"))
    spaceshipImageRed = pygame.image.load(os.path.join("Assets", "red.png"))
    SPACE = pygame.image.load(os.path.join("Assets", "space1.jpg"))
